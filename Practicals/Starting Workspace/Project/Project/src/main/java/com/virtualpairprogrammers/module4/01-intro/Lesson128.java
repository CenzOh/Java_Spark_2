 ...
 * will change to be last 2 seconds. Numbers will go down a bit. You can see the fatal drops down after more than 2 minutes pass.
 * 
-------------------------------------------
...
-------------------------------------------
(DEBUG,44313)
(FATAL,9)            // can see here
(WARN,7940)
(ERROR,926)
(INFO,35457)

 * Look at spark UI to see how complicated it gets. DOesnt run legacy calculations again, it already has the data it just simply adds the totals together. DAG shows it is pretty much
 * repeated operations. So again it goes back to previous RDD caluclations. Again this isnt really production standard. Just simple thing to start with.
 */
