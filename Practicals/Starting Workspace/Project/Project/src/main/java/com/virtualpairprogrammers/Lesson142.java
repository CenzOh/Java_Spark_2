 ...
 * We can write a live dashboard if we want! Event streaming processed by spark, and spark now generates events in micro batches. Makes the jobs run fast, real time. Update dashbaord
 * instantly. Dont need all the data, only the data that has changed. 
 */
