 ...
 * going to finish the module as is anyway. SECOND UPDATE on one of the errors i think i was able to update the JRE to 1.8 so now everything works.
 * 
 ...
 */
		JavaReceiverInputDStream<String> inputData = sc.socketTextStream("localhost", 8989); //first param is host name, then second param is port
