...
public class VPPChapterViews { //linear regression version
...
// lets find out how well it worked, extract linear regression model
		...
		System.out.println("R2 value is " + lrModel.summary().r2()); //finding r2
		System.out.println("coefficients " + lrModel.coefficients() + " intercept: " + lrModel.intercept()); //finding coefficients and intercept
		System.out.println("reg param: " + lrModel.getRegParam() + " elastic net param: " + lrModel.getElasticNetParam()); //finding reg param and elastic net param
		
/* r2 0.39209
 * Coefficients: [2.0987...
 * reg param: 0.1 elastic net param: 1.0
 * 
 * Not particularly low but we were warned it wont be perfect. We have a long list of coefficients there was about 72 of them.
 */
	}
}