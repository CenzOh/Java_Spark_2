 ...
 * Note - the actual model name is called Collaborative Filtering. Matrix Factorization is one of the few approaches on HOW to do collaborative filtering. This approach does have 
 * different mathematical algorithms that can do the calculation and the one spark implemented is called alternating least squares ALS. We will use the objects ALS when makin the model.
 * But in documentation it is known as collaborative filtering. Most people refer to it as matrix factorization.
 */
}
